...
{
    public class AlarmHistoryModel : ViewModelBase
    {
        ...
        private DateTime _alarmClearedDateTime;
        public DateTime AlarmClearedDateTime
        {
            get { return _alarmClearedDateTime; }
            set
            {
                if (_alarmClearedDateTime != value)
                {
                    _alarmClearedDateTime = value;
                    RaisePropertyChanged(nameof(AlarmClearedDateTime));
                }
            }
        }
